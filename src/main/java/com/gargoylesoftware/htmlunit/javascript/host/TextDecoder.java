...
public class TextDecoder extends HtmlUnitScriptable {
    ...
    static {
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("euc-jp");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("euc-kr");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("gb18030");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("ibm866");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("iso-8859-2");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("iso-8859-3");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("iso-8859-4");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("iso-8859-5");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("iso-8859-6");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("iso-8859-7");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("iso-8859-8");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("iso-8859-8-i");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("iso-8859-10");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("iso-8859-13");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("iso-8859-14");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("iso-8859-16");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("koi8-u");
            ENCODINGS_.put("koi8-u", charset);
        });

        tryAddCharset(() -> {
            final Charset charset = Charset.forName("shift_jis");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("windows-1250");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("windows-1253");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("windows-1254");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("windows-1255");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("windows-1256");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("windows-1257");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("windows-1258");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("x-windows-874");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("x-MacCyrillic");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("x-MacRoman");
        ...
        tryAddCharset(() -> {
            final Charset charset = Charset.forName("x-user-defined");
    ...
    // XC: GH#201 begin
    /**
     * Runs the passed code to add a certain charset to {@link #ENCODINGS_} and {@link #ENCODING_NAMES_}. If the charset
     * is unknown on the current platform, ignore it instead of throwing exceptions.
     * 
     * @param addCharsetCode
     *            the code that adds a charset
     */
    private static void tryAddCharset(final Runnable addCharsetCode)
    {
        try
        {
            addCharsetCode.run();
