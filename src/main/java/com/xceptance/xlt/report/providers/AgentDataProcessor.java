...
public class AgentDataProcessor extends AbstractDataProcessor
{
    ...
    public AgentReport createAgentReport()
    {
        ...
        agentReport.transactionErrorsPercentage = (transactions != 0 ? ReportUtils.convertToBigDecimal(100 * (double) transactionErrors/transactions) : ReportUtils.convertToBigDecimal(0));
