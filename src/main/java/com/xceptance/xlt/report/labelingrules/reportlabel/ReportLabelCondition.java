 ...
 */
public class ReportLabelCondition extends LabelingRuleCondition
{
    /**
     * Constructor.
     *
     ...
     */
    public ReportLabelCondition(final String regex)
    {
        super(regex);
    }
    ...
    public static LabelingRuleCondition build(final String regex)
    {
        ...
        {
            return new ReportLabelCondition(regex);
        }
        else
        {
            return new ReportLabelEmptyCondition();
        }
    }
}
