...
public class WebSocketTest extends WebDriverTestCase {
    ...
    public void chat() throws Exception {
        ...
        startWebServer("src/test-hu/resources/com/gargoylesoftware/htmlunit/javascript/host",
    ...
    public void eventsNoSocketServer() throws Exception {
        startWebServer("src/test-hu/resources/com/gargoylesoftware/htmlunit/javascript/host", null, null, null);
        try {
            final WebDriver driver = getWebDriver();
            driver.get(URL_FIRST + "WebSocketTest_wasClean.html");
