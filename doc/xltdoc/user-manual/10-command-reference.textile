...
Example: _addSelection(id=RadioChannel,index=1)_
...
bq(note). Note that CSS hover events are *not* triggered by _mouseOver_ since these are implemented using native browser events.
