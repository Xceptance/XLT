...
<head>
    <@h.head title="XLT Report - Transactions" projectName=projectNameText configuration=report.testreport.configuration />
</head>
...
<div id="container">
    <div id="content">
        ...
        <div id="data-content">
            <@txn.transactions rootNode=report.testreport />
        </div> <!-- data-content -->
