...
<#-- Import sections -->
<#import "/sections/actions.ftl" as actions>
...
<head>
    <@h.head title="XLT Report - Actions" projectName=projectNameText configuration=report.testreport.configuration />
</head>
...
<div id="container">
    <div id="content">
        ...
        <div id="data-content">
            <@actions.actions rootNode=report.testreport />
        </div> <!-- data-content -->
