...
<#-- Import sections -->
<#import "/sections/requests.ftl" as requests>
...
<head>
    <@h.head title="XLT Report - Requests" projectName=projectNameText configuration=report.testreport.configuration />
</head>
...
<div id="container">
    <div id="content">
        ...
        <div id="data-content">
            <@requests.requests rootNode=report.testreport />
        </div> <!-- data-content -->
