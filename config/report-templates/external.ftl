...
<#-- Import sections -->
<#import "/sections/external.ftl" as external>
...
<head>
    <@h.head title="XLT Report - External Data" projectName=projectNameText configuration=report.testreport.configuration />
</head>
