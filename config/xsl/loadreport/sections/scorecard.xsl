                ...
                <xsl:choose>
                    <xsl:when test="$error">
                        <div class="scorecard-verdict-banner">
                            <span class="scorecard-verdict-badge error">ERROR</span>
                            <span class="scorecard-verdict-text">
                                <b>Scorecard evaluation failed.</b> The test could not be evaluated against the scorecard rules.
                            </span>
                        </div>
                        <div class="scorecard-error-box">
                            <p><b>The test could not be evaluated for the following reason:</b></p>
                            <pre class="scorecard-error-message">
                                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <div class="scorecard-verdict-banner">
                            ...
                            <span class="scorecard-verdict-text">
                                ...
                                <xsl:if test="$ratingDef">
                                    <xsl:text> </xsl:text>Rating: <b><xsl:value-of select="$ratingDef/@name" /></b>
                        ...
                        <xsl:if test="count($outcome/groups/group) &gt; 0">
                            <h3>Rule Groups</h3>
                            <table>
                                <thead>
                                    <tr>
                        ...
                        <xsl:choose>
                            ...
                            <xsl:when test="count($outcome/groups/group) &gt; 0 and not($outcome/@testFailed = 'true')">
                                <p style="color: #28a745; font-weight: bold; margin-top: 6px;">All scorecard rules passed successfully.</p>
                            </xsl:when>
                            <xsl:when test="count($outcome/groups/group) &gt; 0 and $outcome/@testFailed = 'true'">
                                <p style="color: #dc3545; font-weight: bold; margin-top: 6px;">The scorecard qualified this test as failed.</p>
                            </xsl:when>
                        </xsl:choose>
