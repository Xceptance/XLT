        ...
        <div class="section" id="general">
            ...
            <div class="content">
                ...
                <div class="charts">
                    <div class="chart">
                        <img>
                            <xsl:attribute name="src">charts/ConcurrentUsers.svg</xsl:attribute>
                            <xsl:attribute name="alt">Concurrent Users</xsl:attribute>
                        </img>
                    </div>
                    <div class="chart">
                        <img>
                            <xsl:attribute name="src">charts/RequestsPerSecond.svg</xsl:attribute>
                            <xsl:attribute name="alt">Requests</xsl:attribute>
                        </img>
                    </div>
                    <div class="chart">
                        <img>
                            <xsl:attribute name="src">charts/RequestRuntime.svg</xsl:attribute>
                            <xsl:attribute name="alt">Request Runtime</xsl:attribute>
                        </img>
                    </div>
                    <div class="chart">
                        <img>
                            <xsl:attribute name="src">charts/TransactionErrors.svg</xsl:attribute>
