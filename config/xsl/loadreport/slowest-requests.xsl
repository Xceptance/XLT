...
<xsl:include href="util/slowest-requests-table.xsl" />

<xsl:include href="text/descriptions.xsl" />

<xsl:include href="sections/slowest-requests.xsl" />
...
<head>
    <xsl:call-template name="head">
        <xsl:with-param name="title" select="'XLT Report - Slowest Requests'" />
    ...
    <div id="content">
        ...
        <div id="data-content">
        	...
        	<!--
        		...
        		************************************
        	-->
			<xsl:call-template name="slowest-requests"/>
