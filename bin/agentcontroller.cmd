...
set JAVA_OPTIONS=%JAVA_OPTIONS% -Dlog4j2.configurationFile="%XLT_CONFIG_DIR%\agentcontroller.properties"
...
set PACKAGES=java.base/java.lang
...
:: run Java
java %JAVA_OPTIONS% com.xceptance.xlt.agentcontroller.AgentControllerMain %*
