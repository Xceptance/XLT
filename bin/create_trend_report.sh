...
JAVA_OPTIONS="$JAVA_OPTIONS -Dlog4j.configuration=\"file:$XLT_CONFIG_DIR/trendreportgenerator.properties\""
...
# run Java
CMD="java $JAVA_OPTIONS com.xceptance.xlt.report.trendreport.TrendReportGeneratorMain"
ARGS=""
I=1
while [ $I -le $# ]; do
    eval x=\${$I}
