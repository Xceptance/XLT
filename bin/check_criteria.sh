...
JAVA_OPTIONS="$JAVA_OPTIONS -Dlog4j.configuration=\"file:$XLT_CONFIG_DIR/check_criteria.properties\""
...
# run Java
CMD="java $JAVA_OPTIONS com.xceptance.xlt.report.criteria.CheckCriteriaMain"
ARGS=""
I=1
while [ $I -le $# ]; do
    eval x=\${$I}
