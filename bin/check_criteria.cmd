...
set JAVA_OPTIONS=%JAVA_OPTIONS% -Dlog4j.configuration="file:%XLT_CONFIG_DIR%\check_criteria.properties"
...
:: run Java
java %JAVA_OPTIONS% com.xceptance.xlt.report.criteria.CheckCriteriaMain %*
