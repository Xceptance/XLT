...
JAVA_OPTIONS="$JAVA_OPTIONS -Dlog4j2.configurationFile=\"$XLT_CONFIG_DIR/mastercontroller.properties\""
...
# run Java
CMD="java $JAVA_OPTIONS com.xceptance.xlt.mastercontroller.MasterControllerMain"
ARGS=""
I=1
while [ $I -le $# ]; do
    eval x=\${$I}
