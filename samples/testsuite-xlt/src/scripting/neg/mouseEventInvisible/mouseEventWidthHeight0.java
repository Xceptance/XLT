 ...
 */
public class mouseEventWidthHeight0 extends AbstractWebDriverScriptTestCase
{
    public static final String TARGET = "id=invisible_anchor_widthheight_0";

    public mouseEventWidthHeight0()
    {
