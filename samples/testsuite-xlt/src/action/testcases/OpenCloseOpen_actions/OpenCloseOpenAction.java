 ...
 */
public class OpenCloseOpenAction extends AbstractHtmlUnitScriptAction
{
     ...
     */
    public OpenCloseOpenAction(final AbstractHtmlPageAction prevAction, final String urlString)
    {
        super(prevAction);
