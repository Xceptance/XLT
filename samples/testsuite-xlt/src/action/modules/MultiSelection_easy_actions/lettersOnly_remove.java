 ...
 */
public class lettersOnly_remove extends AbstractHtmlUnitScriptAction
{
     ...
     */
    public lettersOnly_remove(final AbstractHtmlPageAction prevAction, final String optionLocator)
    {
        super(prevAction);
    ...
    protected void execute() throws Exception
    {
        ...
        page = removeSelection("name=select_9", optionLocator + "=select_9_b");
        assertText("id=cc_change", "change (select_9) select_9_c");
        page = removeSelection("name=select_9", optionLocator + "=select_9_c");
