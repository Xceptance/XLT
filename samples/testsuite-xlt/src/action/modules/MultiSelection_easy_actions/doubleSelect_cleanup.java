 ...
 */
public class doubleSelect_cleanup extends AbstractHtmlUnitScriptAction
{
     ...
     */
    public doubleSelect_cleanup(final AbstractHtmlPageAction prevAction, final String optionLocator)
    {
        super(prevAction);
    ...
    protected void execute() throws Exception
    {
        ...
        page = removeSelection("id=select_9", optionLocator + "=select_9_b");
