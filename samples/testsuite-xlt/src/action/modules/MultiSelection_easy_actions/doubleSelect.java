 ...
 */
public class doubleSelect extends AbstractHtmlUnitScriptAction
{
     ...
     */
    public doubleSelect(final AbstractHtmlPageAction prevAction, final String optionLocator)
    {
        super(prevAction);
    ...
    protected void execute() throws Exception
    {
        ...
        page = addSelection("id=select_9", optionLocator + "=select_9_b");
