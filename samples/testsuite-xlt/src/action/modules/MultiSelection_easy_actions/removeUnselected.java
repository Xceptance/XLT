 ...
 */
public class removeUnselected extends AbstractHtmlUnitScriptAction
{
     ...
     */
    public removeUnselected(final AbstractHtmlPageAction prevAction, final String optionLocator)
    {
        super(prevAction);
