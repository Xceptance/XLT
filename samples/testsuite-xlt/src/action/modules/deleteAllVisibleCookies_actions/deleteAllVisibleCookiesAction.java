 ...
 */
public class deleteAllVisibleCookiesAction extends AbstractHtmlUnitScriptAction
{
     ...
     */
    public deleteAllVisibleCookiesAction(final AbstractHtmlPageAction prevAction)
    {
        super(prevAction);
    }
