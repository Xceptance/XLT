 ...
 */
public class DoubleAction extends AbstractHtmlUnitScriptAction
{
     ...
     */
    public DoubleAction(final AbstractHtmlPageAction prevAction, final String optionLocator)
    {
        super(prevAction);
    ...
    protected void execute() throws Exception
    {
        ...
        page = select("id=select_1", optionLocator + "=select_1_c");
        page = select("id=select_1", optionLocator + "=select_1_c");
